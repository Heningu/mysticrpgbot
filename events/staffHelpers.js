// events/staffHelpers.js

const { EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, ChannelType } = require('discord.js');

/**
 * Function to initiate closure confirmation for staff applications.
...
/**
 * Function to close a staff application by deleting the channel and logging the details.
 * @param {Interaction} interaction - The interaction that triggered the closure.
...
async function closeStaffApplication(interaction, client) {
    ...
    try {
        ...
        await interaction.reply({ content: 'There was an error fetching the application logs.', ephemeral: true });
        return;
    }
    ...
    try {
        ...
        await interaction.reply({ content: 'There was an error closing the staff application.', ephemeral: true });
    }
}
